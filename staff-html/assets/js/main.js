  ...
  $(document).ready(function () {
    ...
    function sidebarActiveTabs(type = "") {
      ...
      if (currentSubLink != "") {
        var currentSubActiveEle = $(
          `a.cr-page-link:contains('${currentSubLink}')`
        ).filter(function () {
    ...
    $(".cr-drop-toggle").on("click", function (e) {
      ...
      if (
        ...
        $(senderElement).parents(".cr-sub-drop-toggle").length > 0
      )
        return;
...
<<<<<<< HEAD
        ...
        if ($(".wrapper").hasClass("sb-default")) {
            ...
            var currentActiveLnk = $("a.cr-page-link").filter(
                `[href='${newURL}']`
            );
...
>>>>>>> main
  ...
  $(document).ready(function () {
    var responsiveDataTable = $("#order-data-table");
...
>>>>>>> main
  ...
  $(".responsive-data-table").each(function () {
  ...
  $(".cr-full-card").on("click", function () {
    ...
    $(this)
      .parent(".header-tools")
      .append(
        '<a href="javascript:void(0)" class="m-l-10 cr-full-card-close"><i class="ri-close-fill"></i></a>'
      );
